		...
		scanf("%d", &choix3) ;
			...
			switch(choix3)
			{
				...
				case 5 : saisie_finale() ;
					break ;
				case 0 : printf("Vous quittez le menu administrateur...A bientot !\n") ;
						 printf("\n")                                                  ;
					break ;
				default : printf("Saisie erronee, veuillez recommencer\n") ;
						  printf("\n")                                     ;
...
void saisie_huitiemes()
{
	...
	if(verif_null("RESULTATSHUITIEMES.txt"))
	{
		...
		for(cpt=0; cpt<NB_MATCHS_HUITIEMES ; cpt++)//sauvegarde des r�sultats saisis dans un fichier d�di� aux huiti�mes
		{
